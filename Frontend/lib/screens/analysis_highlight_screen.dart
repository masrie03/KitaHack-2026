...
class AnalysisHighlightScreen extends StatelessWidget {
  const AnalysisHighlightScreen({Key? key}) : super(key: key);
  ...
  final List<Clause> clauses = const [
    ...
    Clause(
      ...
      /* Using low/safe/informational style */
      plainEnglishExplanation:
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.grey[50], // Light background for document feel
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon:
                const Icon(Icons.share_outlined, color: AppColors.primaryNavy),
            onPressed: () {},
          ),
          IconButton(
        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemCount: clauses.length + 1, // +1 for header
                      ...
                      children: [
                        Text(
                          ...
                          style: AppTextStyles.header.copyWith(
                            color: AppColors
                                .primaryNavy, // Override white from generic header style
                            fontSize: 26,
                          ),
                        ),
