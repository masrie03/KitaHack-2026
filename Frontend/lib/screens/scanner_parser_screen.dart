        ...
        if (_progress >= 1.0) {
          ...
          Future.delayed(const Duration(milliseconds: 500), () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const AnalysisHighlightScreen()),
            );
          });
        }
      });
                  ...
                  GlassCard(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("• PDF documents (max 10MB)",
                            style: AppTextStyles.caption),
                        Text("• Clear, readable text",
                            style: AppTextStyles.caption),
                        Text("• Legal contracts and consent forms",
                            style: AppTextStyles.caption),
                      ],
                    ),
                  ),
                ...
                : [
                    BoxShadow(
                      color: const Color(0xff007AFF).withOpacity(
                          0.3), // Blue shadow for primary actions? Or keep plain
                      blurRadius: 0,
                      offset:
                          const Offset(0, 0), // Minimal shadow for flat design
                    )
                  ]),
        child: Row(
